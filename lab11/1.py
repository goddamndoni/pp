...
if a == 'search':
    ...
    print(result)
if a == 'insert':
    cur.execute("CALL insert_to_phonebook('Raimkhanov Danabek','87081834518')")
if a == 'insertloop':
    cur.execute('''CALL insert_list_of_users(ARRAY[
    ARRAY['Genadi Golovkin', '87076052769'],
    ARRAY['Philip Lahm', '87079815569'],
    ARRAY['John Jones', '87074793780']
]);''')
if a == 'delete':
